...
class Config:
    ...
    BARRES_INFORMATION_MEETING_OPTIONS = environ.get("BARRES_INFORMATION_MEETING_OPTIONS")
    ENTRADES_INFORMATION_MEETING_OPTIONS = environ.get("ENTRADES_INFORMATION_MEETING_OPTIONS")
